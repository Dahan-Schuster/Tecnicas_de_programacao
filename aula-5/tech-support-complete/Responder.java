...
public class Responder
{
    ...
    /**
     * Generate responses from a given set of input words.
     * 
     * @param words  A set of words entered by the user
     * @return       A set of strings that should be displayed as the response
     */
    public HashSet<String> generateResponse(HashSet<String> words)
    {
        ...
        if (allResponses.size() == 0) {
            ...
            allResponses.add(pickDefaultResponse());
        }
